...
## Requirements
 * Have successfully completed **Lab 5**: [Caudal Integration](lab5.html)


## Creating multiple caudal nodes

1. Change current directory to the **caudal-labs** project parent and make two copies of the caudal-labs directory.
...
2. Edit configuration files for every Caudal instance in the cluster:

***caudal-labs/config/caudal-config.clj***
```
(ns caudal-labs)
...
***caudal-labs-n1/config/caudal-config.clj***
```
(ns caudal-labs)
...
***caudal-labs-n2/config/caudal-config.clj***
```
(ns caudal-labs)
...
***caudal-labs-n3/config/caudal-config.clj***
```
(ns caudal-labs)
...
1. Open a terminal for every caudal instance and start them as shown.
...
2. Open another terminal and send some events to te balancer through the **tcp channel** like this.
```
...
1. Verify log outputs for every Caudal instance, contents should be similar to the ones shown below.
